...
<div className=" flex items-center flex-col gap-4">
  <button
className=" w-fit Inter bg-[#F4D800] pt-[6px] pr-[60px] pb-[6px] pl-[60px] Inter text-[#000000] sm:text-[23px] text-[19px] font-[500] text-center border-solid border-0 border-t-2 border-r-2 border-b-2  border-l-2 border-[#ffd500] rounded-tl-[50px] rounded-br-[50px]"  >
Sharpen Your Edge
  </button>
